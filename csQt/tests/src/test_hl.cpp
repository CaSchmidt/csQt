...
class TreeRoot : public csAbstractTreeItem {
public:
  TreeRoot(csAbstractTreeItem *parent = nullptr)
...
public:
  TreeFile(const QString& filename, csAbstractTreeItem *parent = nullptr)
    : TreeRoot(parent)
    , _filename(filename)
  {
  }
...
public:
  TreeLine(const QString& text, const int line,
           ...
           csAbstractTreeItem *parent = nullptr)
    : TreeRoot(parent)
    , _text(text)
    , _line(line)
    , _start(start)
...
csAbstractTreeItem *createModel()
{
...
int main(int argc, char **argv)
{
  ...
  csTreeModel *model = new csTreeModel(createModel(), view);
  view->setModel(model);
